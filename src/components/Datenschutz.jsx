...
function Datenschutz({ setCurrentPage }) {
  return (
      ...
      <div className="container">
        ...
        <div className="legal-content">
          ...
          <div className="legal-section">
            <h3>2. Hosting</h3>
            <p>
              Diese Website wird bei einem externen Hoster gehostet. Die personenbezogenen Daten, die auf dieser Website erfasst werden, werden auf den Servern des Hosters gespeichert.
            </p>
          </div>
          ...
          <div className="legal-section">
            ...
            <h4>Telefonische Kontaktaufnahme</h4>
            <p>
              Wenn Sie uns telefonisch kontaktieren, werden Ihre Angaben aus dem Anruf zwecks Bearbeitung Ihrer Anfrage bei uns gespeichert. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter.
            </p>
          </div>
